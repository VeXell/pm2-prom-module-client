...
Since version 2.0.0 plugin supports collecting all your prom metrics from the runnings apps.
...
## How to collect metrics from you running app

Since plugin version `2.0.0` it allows you collect metrics from all running apps in PM2 and show in one common output with all other PM2 metrics.
